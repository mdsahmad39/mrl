        ...
        <div className='w-full rounded-2xl shadow-slate-900 mx-auto text-white bg-clip-padding backdrop-filter bg-white bg-opacity-10 backdrop-blur-md mt-20 py-10 px-8 justify-center rounded-md'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex justify-center">
                    ...
                    <div className="w-full sm:w-1/4 md:w-1/6 lg:w-1/8 xl:w-1/12 mb-4"><Link href="/users" className="backdrop bg-white bg-opacity-0 border border-gray px-3 py-1.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-200 focus:ring-opacity-40 hover:bg-opacity-50 text-lg">Cancel</Link></div>
                </div>
            </form>
        </div>
    );
